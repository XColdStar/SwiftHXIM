...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0) {
        ...
        [HXRootVCManager pushChartVCWithContactId:contact];
//        EMChatViewController *chatController = [[EMChatViewController alloc] initWithConversationId:contact type:EMConversationTypeChat createIfNotExist:YES];
